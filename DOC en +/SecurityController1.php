...
//        }
        ...
        return $this->redirectToRoute('resend-emailvalidation');
    }

    /**
     * Ré-envoie un email de validation (si l'utilisateur a cliqué trop tard sur le lien du mail)
     * @Route("/resend-emailvalidation", name="resend-emailvalidation")
     *
     * @param AuthenticationUtils $authUtils
     *
     * @return Response
     */
    public function resendemailvalidationAction(Request $request, EntityManagerInterface $em, UserPasswordEncoderInterface $passwordEncoder, UserEmailService $userEmailService)
    {
